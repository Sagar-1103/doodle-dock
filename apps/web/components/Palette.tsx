...
export default function Palette() {
  ...
  const changePalette = ({stroke,bg,radii,lineDash}:PaletteTypes)=>{
    setPalette({stroke,bg,radii,lineDash});
    canvasEngine?.changeSelectedPalette({stroke,bg,radii,lineDash})
}
    ...
    <div className="min-w-52 py-3 cursor-default px-4 flex flex-col gap-y-4 text-white font-normal text-sm bg-[#202025] backdrop-blur-md shadow-lg border border-[#3f3f44]/70 rounded-md">
      ...
      <div>
        ...
        <div className="flex mt-1 gap-x-1.5">
          <div onClick={()=>changePalette({stroke:"#ffffff",bg:palette.bg,radii:palette.radii,lineDash:palette.lineDash})} className="w-6 h-6 bg-gray-100 rounded-sm hover:cursor-pointer"></div>
          <button onClick={()=>changePalette({stroke:"#ff6467",bg:palette.bg,radii:palette.radii,lineDash:palette.lineDash})} className="w-6 h-6 bg-red-400 rounded-sm hover:cursor-pointer"></button>
          <button onClick={()=>changePalette({stroke:"#05df72",bg:palette.bg,radii:palette.radii,lineDash:palette.lineDash})} className="w-6 h-6 bg-green-400 rounded-sm hover:cursor-pointer"></button>
          <div onClick={()=>changePalette({stroke:"#50a2ff",bg:palette.bg,radii:palette.radii,lineDash:palette.lineDash})} className="w-6 h-6 bg-blue-400 rounded-sm hover:cursor-pointer"></div>
          <div onClick={()=>changePalette({stroke:"#ff8904",bg:palette.bg,radii:palette.radii,lineDash:palette.lineDash})} className="w-6 h-6 bg-orange-400 rounded-sm hover:cursor-pointer"></div>
      ...
      <div>
        <p>Background</p>
        <div className="flex mt-1 gap-x-1.5">
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:palette.radii,bg:null})} className="w-6 h-6 bg-[#202025] border rounded-sm hover:cursor-pointer"></div>
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:palette.radii,bg:"#ffc9c9"})} className="w-6 h-6 bg-[#ffc9c9] rounded-sm hover:cursor-pointer"></div>
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:palette.radii,bg:"#b2f2bb"})} className="w-6 h-6 bg-[#b2f2bb] rounded-sm hover:cursor-pointer"></div>
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:palette.radii,bg:"#a5d8ff"})} className="w-6 h-6 bg-[#a5d8ff] rounded-sm hover:cursor-pointer"></div>
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:palette.radii,bg:"#ffec99"})} className="w-6 h-6 bg-[#ffec99] rounded-sm hover:cursor-pointer"></div>
          <p className="text-gray-300"> | </p>
      ...
      <div>
        <p>Stroke style</p>
        <div className="flex mt-1 gap-x-1.5">
            <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:[0,0],radii:palette.radii,bg:palette.bg})} className={`w-7 h-7 ${palette.lineDash[0]===0 && palette.lineDash[1]===0 ?"bg-[#6d6da4]":"bg-[#585862]/50"} rounded-sm hover:cursor-pointer p-1`} >
            <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"><path d="M4.167 10h11.666" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"></path></svg>
            </div>
            <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:[6,4],radii:palette.radii,bg:palette.bg})} className={`w-7 h-7 ${palette.lineDash[0]===6 && palette.lineDash[1]===4 ?"bg-[#6d6da4]":"bg-[#585862]/50"} rounded-sm hover:cursor-pointer p-1`} >
            ...
            <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:[2,2],radii:palette.radii,bg:palette.bg})} className={`w-7 h-7 ${palette.lineDash[0]===2 && palette.lineDash[1]===2 ?"bg-[#6d6da4]":"bg-[#585862]/50"} rounded-sm hover:cursor-pointer p-1`} >
      ...
      <div>
        <p>Edges</p>
        <div className="flex mt-1 gap-x-1.5">
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:0,bg:palette.bg})} className={`w-7 h-7 ${palette.radii==0?"bg-[#6d6da4]":"bg-[#585862]/50"} rounded-sm hover:cursor-pointer p-1`}>
          ...
          <div onClick={()=>changePalette({stroke:palette.stroke,lineDash:palette.lineDash,radii:70,bg:palette.bg})} className={`w-7 h-7 ${palette.radii==70?"bg-[#6d6da4]":"bg-[#585862]/50"} rounded-sm hover:cursor-pointer p-1`}>
